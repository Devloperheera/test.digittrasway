...
<div class="container-fluid mt-4">
    ...
    <div class="row mb-3">
        ...
        <form action="{{ route('distance-pricings.store') }}" method="POST" id="pricingForm">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number"
                           ...
                           id="distance_to"
                           name="distance_to"
                           value="{{ old('distance_to') }}"
                           min="0"
                           placeholder="e.g., 25 or leave empty">
                    @error('distance_to')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror"
                              ...
                              name="description"
                              rows="3"
                              placeholder="Enter pricing description...">{{ old('description') }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="card bg-light mb-3">
                <div class="card-body">
                    ...
                    <p class="mb-0" id="pricePreview">Fill in the details to see preview</p>
                </div>
            </div>
