...
@section('content')
    <div class="container-fluid mt-4">
        <div class="form-section">
            ...
            <form action="{{ route('truck-specifications.store') }}" method="POST" id="specificationForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('tyre_count') is-invalid @enderror" id="tyre_count"
                            name="tyre_count" value="{{ old('tyre_count') }}" min="2" placeholder="e.g., 6" required>
                        @error('tyre_count')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('length') is-invalid @enderror" id="length"
                            name="length" value="{{ old('length') }}" min="0" step="0.01" placeholder="e.g., 20"
                            required>
                        @error('length')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <select class="form-select @error('length_unit') is-invalid @enderror" id="length_unit"
                            ...
                            <option value="ft" {{ old('length_unit', 'ft') == 'ft' ? 'selected' : '' }}>Feet</option>
                            <option value="m" {{ old('length_unit') == 'm' ? 'selected' : '' }}>Meters</option>
                        </select>
                        @error('length_unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('height') is-invalid @enderror" id="height"
                            name="height" value="{{ old('height') }}" min="0" step="0.01" placeholder="e.g., 8"
                            required>
                        @error('height')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-2 mb-3">
                        ...
                        <select class="form-select @error('height_unit') is-invalid @enderror" id="height_unit"
                            ...
                            <option value="ft" {{ old('height_unit', 'ft') == 'ft' ? 'selected' : '' }}>Feet</option>
                            <option value="m" {{ old('height_unit') == 'm' ? 'selected' : '' }}>Meters</option>
                        </select>
                        @error('height_unit')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_weight') is-invalid @enderror" id="max_weight"
                            name="max_weight" value="{{ old('max_weight') }}" min="0" step="0.01"
